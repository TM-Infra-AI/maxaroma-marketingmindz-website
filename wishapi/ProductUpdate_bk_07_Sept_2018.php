...
$vemail = "naresh.qualdev@gmail.com";
$sendmessage = "In Maxaroma First Wish Product Update Cron End on ".date('Y-m-d H:i:s');	
$test 	= @mail($vemail,"In Maxaroma First Wish Product Update Cron End",$sendmessage);
