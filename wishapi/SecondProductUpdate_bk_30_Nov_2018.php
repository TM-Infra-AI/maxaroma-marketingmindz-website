...
$newsql .="  AND `" . TABLE_PREFIX . "category`.category_id NOT IN('68','69','70','71','90','91','93','94','6','9','43') ";
$newsql .="  AND `" . TABLE_PREFIX . "products`.sku NOT IN('UP8053672743760','UP8053672789775','UP8053672770438','UP8053672561814','UP8053672559705','UP8053672737660','UP018600','T5060103310395','UP805289048534','UP8053672797138','UP8053672836998','UP3360372728313') ";
$newsql .="  AND `".TABLE_PREFIX."products`.brand_id = `".TABLE_PREFIX."brand`.brand_id ";
$newsql .="  AND `" . TABLE_PREFIX . "products`.imanufactureid!=335";
$newsql .="  AND `" . TABLE_PREFIX . "products`.is_wish_disable='No'";
