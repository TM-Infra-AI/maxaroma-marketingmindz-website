...
$sql .="  AND `" . TABLE_PREFIX . "products`.is_wish_disable='Yes'";
$sql .="  AND `" . TABLE_PREFIX . "products`.is_sent_wish_disable='No'";
...
if($total_prod > 0)
{
	...
	for($b=0; $b < $total_record_batch; $b++ )
	{
		 ...
		 $sel_pro .="  AND `" . TABLE_PREFIX . "products`.is_wish_disable='Yes'";
		 $sel_pro .="  AND `" . TABLE_PREFIX . "products`.is_sent_wish_disable='No'";
		...
		for($i=0;$i<$TotalProducts;$i++)
		{
			...
			{
				$sql = "Update `" . TABLE_PREFIX . "products` SET is_sent_wish_disable='Yes' WHERE products_id='".$prodRes[$i]["products_id"]."'";
