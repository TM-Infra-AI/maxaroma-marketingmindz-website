...
if($total_prod > 0)
{
	...
	{
		 $sel_pro = " SELECT DISTINCT(`" . TABLE_PREFIX . "products`.sku),`" . TABLE_PREFIX . "category`.parent_id, `" . TABLE_PREFIX . "products`.current_stock, ";
		 $sel_pro .= $fetch;
	  ...
	  //  echo $sel_pro; exit;
		...
		for($i=0;$i<$TotalProducts;$i++)
		{
			...
			else
			{
			 ...
			 $udpRefer = $obj->update(TABLE_PREFIX.'products_one', $wishArr, " `sku` = '".$sku."'");
