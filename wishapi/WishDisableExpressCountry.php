...
$sql = " SELECT DISTINCT(`" . TABLE_PREFIX . "products`.sku) ,".$fetch." ,".$current_stock_check ;
...
$sql .="  AND `" . TABLE_PREFIX . "products_one`.is_wish_express='Yes' AND   `" . TABLE_PREFIX . "products`.sku='UP3365440375079'";
...
$sql .="  having  product_price > 0 AND current_stock<=0";	
...
if($total_prod > 0)
{
	...
	for($b=0; $b < $total_record_batch; $b++ )
	{
		 ...
		 $sel_pro .="  AND `" . TABLE_PREFIX . "products_one`.is_wish_express='Yes' ";
		 ...
		 $sel_pro .= " AND `" . TABLE_PREFIX . "products_one`.is_wish_created='Yes' AND   `" . TABLE_PREFIX . "products`.sku='UP3365440375079'";
		 ...
		 $sel_pro .= " HAVING product_price > 0 AND current_stock<=0";
