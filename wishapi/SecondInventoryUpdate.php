...
$sendmessage = "Wish Second Product Inventory start Cron In Wish API On Maxaroma At ".date('m-d-Y');	
$test 	= @mail($vemail,"Wish Second Product Inventory start Cron In Wish API On Maxaroma",$sendmessage);
...
$newsql .="  AND `" . TABLE_PREFIX . "category`.category_id NOT IN('68','69','70','71','90','91','93','94','6','9','43','202') ";
$newsql .="  AND `" . TABLE_PREFIX . "products`.sku NOT IN('UP8053672743760','UP8053672789775','UP8053672770438','UP8053672561814','UP8053672559705','UP8053672737660','UP018600','T5060103310395','UP3360372728313') ";
...
{
	$vemail = "naresh.qualdev@gmail.com";
	$sendmessage = "Wish Second Product Inventory Failed In Wish API On Maxaroma At ".date('m-d-Y') . " And The Product SKU Is ".$skulist;	
	$test 	= @mail($vemail,"Wish Second Product Inventory Failed In Wish API On Maxaroma For First Cron",$sendmessage);
}

$vemail = "naresh.qualdev@gmail.com";
$sendmessage = "Wish Second Product Inventory End Cron In Wish API On Maxaroma At ".date('m-d-Y');	
$test 	= @mail($vemail,"Wish SecondProduct Inventory End Cron In Wish API On Maxaroma",$sendmessage);
