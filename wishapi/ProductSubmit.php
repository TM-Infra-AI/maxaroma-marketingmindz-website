...
$myFile = '/home/maxaroma/public_html/Logs/ProductSubmit.txt';
if(filesize($myFile)==10000000)
{
	rename($myFile,"/home/maxaroma/public_html/Logs/ProductSubmit_bk.txt");
	unlink($myFile);
}
...
if(fopen($myFile, 'a+'))
{
	...
	$stringData .= date("m/d/Y H:i:s")." : ProductSubmit.php :  Wish Product Create Start  : Wish Product Create\n";
...
$sql .="  AND `" . TABLE_PREFIX . "products`.status = '1' AND `" . TABLE_PREFIX . "products_one`.is_wish_created='No' ";
$sql .="  AND `".TABLE_PREFIX."products`.brand_id = `".TABLE_PREFIX."brand`.brand_id ";
$sql .="  AND `" . TABLE_PREFIX . "category`.category_id NOT IN('68','69','70','71','90','91','93','94','6','9','43','202') ";
$sql .="  AND `" . TABLE_PREFIX . "products`.sku NOT IN('UP8053672743760','UP8053672789775','UP8053672770438','UP8053672561814','UP8053672559705','UP8053672737660','UP018600','T5060103310395','UP805289048534','UP8053672797138','UP8053672836998','UP3360372728313') ";
$sql .="  AND `" . TABLE_PREFIX . "products`.imanufactureid!=335";
$sql .="  AND `" . TABLE_PREFIX . "products_one`.is_wish_disable='No'";
$sql .= " AND `" . TABLE_PREFIX . "products`.products_id = `" . TABLE_PREFIX . "products_one`.products_id ";
$sql .="  AND `" . TABLE_PREFIX . "products`.current_stock > 5 ";
...
if($total_prod > 0)
{
	...
	for($b=0; $b < $total_record_batch; $b++ )
	{
     ...
     $sel_pro .= " `" . TABLE_PREFIX.  "products`.UPC, "; 
     $sel_pro .= " `" . TABLE_PREFIX.  "products_one`.extra_images, "; 
	 ...
	 $sel_pro .= " AND `" . TABLE_PREFIX . "products`.status = '1' AND `" . TABLE_PREFIX . "products_one`.is_wish_created='No' ";
	 $sel_pro .="  AND `" . TABLE_PREFIX . "category`.category_id NOT IN('68','69','70','71','90','91','93','94','6','9','43','202') ";
	 $sel_pro .="  AND `" . TABLE_PREFIX . "products`.sku NOT IN('UP8053672743760','UP8053672789775','UP8053672770438','UP8053672561814','UP8053672559705','UP8053672737660','UP018600','T5060103310395','UP805289048534','UP8053672797138','UP8053672836998','UP3360372728313') ";
	 $sel_pro .="  AND `" . TABLE_PREFIX . "products`.imanufactureid!=335";
	 $sel_pro .="  AND `" . TABLE_PREFIX . "products_one`.is_wish_disable='No'";
	 $sel_pro .="  AND `" . TABLE_PREFIX . "products`.current_stock > 5 ";
	 ...
	 $TotalProducts = count($prodRes);
		...
		try {
			...
			if($newResOF!='error')
			{
				$sql = "Update `" . TABLE_PREFIX . "products_one` SET is_wish_created='Yes' WHERE products_id='".$prodRes[$i]["products_id"]."'";
...
if(fopen($myFile, 'a+'))
{
	$fh = fopen($myFile, 'a+');
	$stringData = "";
	$stringData .= date("m/d/Y H:i:s")." : ProductSubmit.php :  Wish Product Create End  : Wish Product End\n";
	fwrite($fh, $stringData);
	fclose($fh);
}
unset($obj);
