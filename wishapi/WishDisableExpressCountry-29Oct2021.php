...
$sql .="  AND `" . TABLE_PREFIX . "products`.is_wish_express='Yes' AND   `" . TABLE_PREFIX . "products`.sku='UP3365440375079'";
...
if($total_prod > 0)
{
	...
	for($b=0; $b < $total_record_batch; $b++ )
	{
		 ...
		 $sel_pro .="  AND `" . TABLE_PREFIX . "products`.is_wish_express='Yes' ";
		 ...
		 $sel_pro .= " AND `" . TABLE_PREFIX . "products`.is_wish_created='Yes' AND   `" . TABLE_PREFIX . "products`.sku='UP3365440375079'";
