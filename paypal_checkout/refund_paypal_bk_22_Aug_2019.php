...
function process_Refund_Payment_Paypal($orders_id = NULL,$refund_amount=0,$refund_comment = '',$orders_no='',$refund_shipping_cost=0,$refund_restocking_fee=0)
{
	...
	## Must required if Partial Refund
	$nvpstr .= "&AMT=".$x_amount;
	$nvpstr .= "&NOTE=".urlencode("Refund Transaction at Maxaroma.com - Order # ".$x_memo);
	...
	$slq = "SELECT total_refund_amount,refund_transaction_response, refund_comment,order_total,customer_id,apply_credit FROM `".TABLE_PREFIX."orders` WHERE orders_id = '".(int)$orders_id."' LIMIT 0,1";
	...
	$new_refund_comment  .= "Refund processed by : <b>".$_SESSION['sess_admin_email']."</b> on date ".date('m/d/Y H:i:s')."<br><br>Original Shipping Cost:".$refund_shipping_cost."<br>Restocking Fee:".$refund_restocking_fee."<br><br>" ;
	/*$arrUp = array(
