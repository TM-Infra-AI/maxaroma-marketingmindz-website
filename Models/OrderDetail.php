...
class OrderDetail extends Model
{
     ...
     */
    protected $fillable = [
        'orders_id', 'orders_no', 'products_id', 'sku', 'product_name', 'attribute_info', 'quantity', 'price', 'total', 'status', 'item_price', 'eback_order', 'ereturn_item', 'returned_qty', 'returned_note', 'dtl_ship_status', 'dtl_ship_method', 'dtl_tracking_no', 'dtl_ship_date', 'percent_discount', 'item_qty_discount', 'display_price', 'free_product', 'excluded_flag', 'is_gift_wrap', 'is_free_gift_products', 'VendorSKU', 'IsCosmo', 'IsNandansons', 'IsPerfumePW', 'IsPCA', 'po_number', 'is_po_number', 'is_outofstock', 'out_of_stock_qty', 'coupon_itemwise_discount', 'handling_time_str', 'ostatus'
    ];
