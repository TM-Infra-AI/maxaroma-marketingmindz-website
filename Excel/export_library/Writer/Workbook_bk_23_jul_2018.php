...
require_once (EXPORT_LIB .'Writer/Format.php');
require_once (EXPORT_LIB .'Writer/BIFFwriter.php');
require_once (EXPORT_LIB .'Writer/Worksheet.php');
require_once (EXPORT_LIB .'Writer/Parser.php');
require_once (EXPORT_LIB .'OLE/PPS/Root.php');
require_once (EXPORT_LIB .'OLE/PPS/File.php');
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
		global $Invoice_Excel, $Excel_Reports;
