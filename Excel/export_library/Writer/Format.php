...
require_once (EXPORT_LIB . 'PEAR.php');
...
class Spreadsheet_Excel_Writer_Format extends PEAR
{
    ...
    */
    function Spreadsheet_Excel_Writer_Format($BIFF_version, $index = 0, $properties =  array())
    {
        ...
        $this->_bottom_color   = 0x16;
        $this->_top_color      = 0x16;
        $this->_left_color     = 0x16;
        $this->_right_color    = 0x16;
        $this->_diag_color     = 0x16;
