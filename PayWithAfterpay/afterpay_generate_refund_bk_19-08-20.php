<?php
	...
	function process_Refund_Payment_Afterpay($orders_id = NULL,$refund_amt=0,$refund_comment = '')
	{ 
		global $obj;
		...
		## Update Order Table Start #############
			...
			$new_refund_comment  .= "Refund processed by : <b>".$_SESSION['sess_admin_email']."</b> on date ".date('m/d/Y H:i:s')."<br><br>" ;
